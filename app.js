...
(function () {
  ...
  function icon(name, cls) {
    ...
    span.innerHTML = `<svg viewBox="0 0 24 24" width="100%" height="100%" fill="none" stroke="currentColor" stroke-width="1.6">${paths[name] || ""}</svg>`;
    return span;
  }
...
(function () {
  ...
  function renderQuiz(container) {
    ...
    function renderDone() {
      ...
      const logoImg = el("img", { src: "icons/icon-96.png", alt: "", class: "quiz-done-logo" });
...
(function () {
  ...
  function buildShell() {
    ...
    brand.appendChild(el("img", { src: "icons/icon-96.png", alt: "Vāgdevi", class: "brand-logo" }));
